...
test_that(
  ...
  code = {
    ...
    xgboost_optimization$performance_metric_args <- list(positive = "1")
    xgboost_optimization$performance_metric <- mlexperiments::metric("auc")
    xgboost_optimization$performance_metric_name <- "AUC"
...
test_that(
  ...
  code = {
    ...
    expect_equal(dim(tune_results), c(ncores + 10, 18))
