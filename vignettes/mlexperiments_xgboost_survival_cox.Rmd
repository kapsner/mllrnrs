...
See [https://github.com/kapsner/mllrnrs/blob/main/R/learner_surv_xgboost_cox.R](https://github.com/kapsner/mllrnrs/blob/main/R/learner_surv_xgboost_cox.R) for implementation details.
...
train_x <- model.matrix(
  ~ -1 + .,
  dataset[data_split$train, .SD, .SDcols = setdiff(feature_cols, surv_cols[1:2])]
)
...
tuner <- mlexperiments::MLTuneParameters$new(
  learner = mllrnrs::LearnerSurvXgboostCox$new(
    metric_optimization_higher_better = TRUE
  ),
  strategy = "grid",
  ncores = ncores,
  seed = seed
