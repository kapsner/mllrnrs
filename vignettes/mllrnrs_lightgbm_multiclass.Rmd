...
Here, `lightgbm`'s [`weight`-argument](https://lightgbm.readthedocs.io/en/latest/R/reference/lgb.Dataset.html) is used to rescale the class-weights during the training.
...
#> 1:          1        0.08445446      24              0.6              0.6                4           0.2         18        -1
#> 2:          2        0.07807961      29              0.8              1.0               10           0.2          6        -1
#> 3:          3        0.09966657     100              0.8              0.8                4           0.1          2        -1
#> 4:          4        0.08054141      48              1.0              0.8                4           0.1         10        -1
#> 5:          5        0.08262796      19              1.0              0.6                6           0.2         18        -1
#> 6:          6        0.09273392      41              1.0              1.0                8           0.1         14        -1
#>    verbose  objective        metric num_class
#>      <int>     <char>        <char>    <char>
#> 1:      -1 multiclass multi_logloss         3
#> 2:      -1 multiclass multi_logloss         3
...
#> 1:  Fold1   0.6507174              0.8              0.6                8           0.1         14      66        -1      -1
#> 2:  Fold2   0.6458434              0.8              0.6                8           0.1         14      66        -1      -1
#> 3:  Fold3   0.6493135              0.8              0.6                8           0.1         14      66        -1      -1
#>     objective        metric num_class
#>        <char>        <char>    <char>
#> 1: multiclass multi_logloss         3
#> 2: multiclass multi_logloss         3
