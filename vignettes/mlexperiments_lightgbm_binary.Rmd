---
title: "lightgmb: Binary Classification"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteEncoding{UTF-8}
  %\VignetteIndexEntry{lightgmb: Binary Classification}
...
See [https://github.com/kapsner/mllrnrs/blob/main/R/learner_lightgmb.R](https://github.com/kapsner/mllrnrs/blob/main/R/learner_lightgmb.R) for implementation details.
...
```{r}
preds_lightgmb <- mlexperiments::predictions(
  object = validator,
  newdata = test_x
)
```
...
```{r}
perf_lightgmb <- mlexperiments::performance(
  object = validator,
  prediction_results = preds_lightgmb,
