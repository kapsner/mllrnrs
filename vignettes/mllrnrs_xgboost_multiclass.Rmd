...
Here, `xgboost`'s [`weight`-argument](https://rdrr.io/cran/xgboost/man/setinfo.html) is used to rescale the class-weights during the training.
...
head(tuner_results_grid)
#>    setting_id metric_optim_mean nrounds subsample colsample_bytree min_child_weight learning_rate max_depth
#>         <int>             <num>   <int>     <num>            <num>            <num>         <num>     <num>
#> 1:          1         0.5411292      42       0.6              0.8                5           0.2         1
#> 2:          2         0.5364912      82       1.0              0.8                5           0.1         5
#> 3:          3         0.5396050     100       0.8              0.8                5           0.1         1
#> 4:          4         0.5328722      31       0.6              0.8                5           0.2         5
#> 5:          5         0.5399017      63       1.0              0.8                1           0.1         5
#> 6:          6         0.5308301      76       0.8              0.8                5           0.1         5
#>         objective eval_metric num_class
#>            <char>      <char>     <num>
#> 1: multi:softprob    mlogloss         3
#> 2: multi:softprob    mlogloss         3
#> 3: multi:softprob    mlogloss         3
#> 4: multi:softprob    mlogloss         3
#> 5: multi:softprob    mlogloss         3
#> 6: multi:softprob    mlogloss         3
```
...
#> 1:  Fold1   0.3994027 0.5356077        0.8312972                1     0.1099728        10      23
#> 2:  Fold2   0.3726661 0.5356077        0.8312972                1     0.1099728        10      23
#> 3:  Fold3   0.3862323 0.5356077        0.8312972                1     0.1099728        10      23
#>         objective eval_metric num_class
#>            <char>      <char>     <num>
#> 1: multi:softprob    mlogloss         3
#> 2: multi:softprob    mlogloss         3
